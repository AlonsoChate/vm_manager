...
function lg_example_home(){
    ...
    ./LG_B1_Client -k true -M yes -K 60 -f /dev/shm/looking-glass0 -a true -t "Android Home"
}
...
function lg_example_setting(){
    ...
    ./LG_B1_Client -k true -M yes -K 60 -f /dev/shm/looking-glass1 -a true -t "Android Setting"
}
...
function lg_example_documents(){
    ...
    ./LG_B1_Client -k true -M yes -K 60 -f /dev/shm/looking-glass2 -a true -t "Android Documents"
}
...
function lg_example_webview(){
    ...
    ./LG_B1_Client -k true -M yes -K 60 -f /dev/shm/looking-glass3 -a true -t "Android WebView"
}
